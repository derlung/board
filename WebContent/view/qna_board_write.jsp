...
<section class="content">
	<div class="box box-primary">
		...
		<form action="../qWrite.do" id="writeForm" method="post" role="form"
			...
			<div class="box-body">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<textarea name='content' id ='content' cols='60' class="form-control" rows='15'
							></textarea>
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="file" id="file" name="file"> <small class="text-muted" id="file">(파일크기
							: 2MB)</small>
					</div>
				</div>
				<div style="height: 20px"></div>
