			...
			<div class="box-body">
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" name="name" size="10" class="form-control"
							maxlength='10' value='${vo.name}' readonly>
					</div>
				</div>
				<div class="form-group  row">
					...
					<div class="col-sm-10">
						<input type="text" name="title" size="50" class="form-control"
							maxlength='100' value='${vo.title}' readonly>
					</div>
				</div>
				<div class="form-group  row">
					<label for="content" class="col-sm-2 col-form-label">내용</label>
					<div class="col-sm-10">
						<textarea name='board_content' cols='60' class="form-control"
							rows='15' readonly>${vo.content}</textarea>
					</div>
				</div>
				<div class="form-group  row">
					<label for="filename" class="col-sm-2 col-form-label">파일첨부</label>
					<div class="col-sm-10">
						<c:if test="${empty vo.attach}">첨부파일 없음</c:if>
						<c:if test="${!empty vo.attach}">
							...
							%>
							<a href="view/download.jsp?fileName=${attach}">${attach}</a>
						</c:if>
					</div>
				</div>
				...
				<div class="box-footer text-center">
					...
					<button type="button" class="btn btn-primary" id="list"
						onclick="location.href='qList.do'">목록보기</button>
				</div>
				<div style="height: 20px"></div>
			</div>
		</form>
...
// 			location.href="view/qna_board_modify.jsp";
			formObj.submit();
